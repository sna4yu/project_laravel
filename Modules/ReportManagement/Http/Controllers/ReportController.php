...
class ReportController extends Controller
{
    ...
    public function getProfitLoss(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('reportmanagement::Profit.Loss.index', compact('data'))->render();
        }

        $business_locations = BusinessLocation::forDropdown($business_id, true);

        return view('reportmanagement::Profit.Loss.index', compact('business_locations'));
    }
    ...
    public function getPurchaseSell(Request $request)
    {
        ...
        return view('reportmanagement::Purchase_sell.index')
    ...
    public function getCustomerSuppliers(Request $request)
    {
        ...
        return view('reportmanagement::Supplier_customer.index')
    ...
    public function getStockReport(Request $request)
    {
        ...
        return view('reportmanagement::stock_report.index')
    ...
    public function getTaxReport(Request $request)
    {
        ...
        return view('reportmanagement::Tax_report.index')
    ...
    public function getTrendingProducts(Request $request)
    {
        ...
        return view('reportmanagement::Trending_product.index')
    ...
    public function getStockAdjustmentReport(Request $request)
    {
        ...
        return view('reportmanagement::Stock_adjustment.stock_adjustment_report')
            ->with(compact('business_locations'));
    }
    ...
    public function getRegisterReport(Request $request)
    {
        ...
        return view('reportmanagement::register_report.index')
    ...
    public function getSalesRepresentativeReport(Request $request)
    {
        ...
        return view('reportmanagement::sales_representative.index')
    ...
    public function getStockExpiryReport(Request $request)
    {
        ...
        return view('reportmanagement::Stock_expire.stock_expiry_report')
     ...
     * @return \Illuminate\Http\Response
     */
    public function updareportmanagementockExpiryReport(Request $request)
    {
        if (!auth()->user()->can('stock_report.view')) {
            abort(403, 'Unauthorized action.');
        }
    ...
    public function getCustomerGroup(Request $request)
    {
        ...
        return view('reportmanagement::Customer_group.index')
    ...
    public function getproductPurchaseReport(Request $request)
    {
        ...
        return view('reportmanagement::product_purchase.index')
    ...
    public function getproductSellReport(Request $request)
    {
        ...
        return view('reportmanagement::product_sell.index')
            ->with(compact(
                'business_locations',
                'customers',
                'categories',
    ...
    public function purchasePaymentReport(Request $request)
    {
        ...
        return view('reportmanagement::purchase_payment.index')
    ...
    public function sellPaymentReport(Request $request)
    {
        ...
        return view('reportmanagement::sell_payment_report.index')
    ...
    public function itemsReport()
    {
        ...
        return view('reportmanagement::Items_report.index')->with(compact('suppliers', 'customers', 'business_locations'));
    }
    ...
    public function activityLog()
    {
        ...
        return view('reportmanagement::activity_log.index')->with(compact('users', 'transaction_types'));
    }
    ...
    {
        return view('reportmanagement::AccountingReport.index');
    }
