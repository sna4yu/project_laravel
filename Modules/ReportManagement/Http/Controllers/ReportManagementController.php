...
class ReportManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('reportmanagement::Report_management.index')
    ...
    {
        return view('reportmanagement::Report_management.people');
    }
    public function operation()
    {
        return view('reportmanagement::Report_management.operation');
    }
    public function financial()
    {
        return view('reportmanagement::Report_management.financial');
    }
    public function other()
    {
        return view('reportmanagement::Report_management.other');
    }
}
