                            ...
                            <div class="row">
                                ...
                                @can('essentials.crud_all_attendance')
                                    <div class="col-md-6 spacer">
                                        ...
                                        <div class="col-md-4">
                                            <form action="{{ route('export.attendance') }}" method="get" class="pull-right"
                                                id="export_form">
                                                @csrf
                                                {{-- <input type="hidden" name="employee_id" id="export_employee_id" value=""> --}}
                                                <input type="hidden" name="date_range" id="export_date_range" value="">
                                                <button type="submit" class="btn btn-success"><i class="fa fa-download"></i>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#export_form').submit(function(event) {
                ...
                // Set values
                // $('#export_employee_id').val($('#employee_id').val());
