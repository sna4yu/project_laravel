...
class BudgetActualController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('quickbooks::business_overview.budget_actuals.index')->with(compact('accounts', 'budget', 'months', 'fy_year',
                'account_types'));
    }
    ...
    public function create()
    {
        ...
        return view('quickbooks::business_overview.budget_actuals.create')->with(compact('fy_year', 'accounts', 'months', 'budget'));
    }
