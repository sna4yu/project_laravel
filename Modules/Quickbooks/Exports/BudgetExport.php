...
namespace Modules\Quickbooks\Exports;
...
class BudgetExport implements FromView
{
    ...
    public function view(): View
    {
        if ($this->view_type == 'monthly') {
            return view('quickbooks::budget.partials.budget_monthly_excel')->with([
            ...
            return view('quickbooks::budget.partials.budget_quarterly_excel')->with([
                'accounts' => $this->accounts,
                'budget' => $this->budget,
                'months' => $this->months,
                'account_types' => $this->account_types,
            ...
            return view('quickbooks::budget.partials.budget_yearly_excel')->with([
                'accounts' => $this->accounts,
                'budget' => $this->budget,
                'months' => $this->months,
