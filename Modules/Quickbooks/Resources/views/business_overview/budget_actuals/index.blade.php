...
@section('title', __('Budget VS Actuals'))
    ...
    <div class="row" style="padding: 20px; background-color: #ffffff;">
        <div class="box-body" style="background-color: #F4F5F8;">
            ...
            <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 20px; padding-left: 12px;">
                Budget vs. Actuals: Budget_FY24_P&L - FY24 P&L</h3>
    ...
    <div class="card-body">
        <div class="row mb-10" style="display: flex; align-items: center;">
            ...
            <div class="col-md-4" style="flex-grow: 1;">
                <div class="form-group">
                    <label for="fiscal_year_picker">Budget</label>
            ...
            <div class="col-md-4" style="flex-grow: 1;">
                <div class="form-group">
                    ...
                    <div class="dropdown" style="position: relative;">
                        <select class="form-control" id="dropdownMenuButton" style="font-size: 12px; width: 220px; cursor: pointer;" aria-haspopup="true" aria-expanded="false">
            ...
            <!-- Run report Button with margin-top to lower its height -->
            <div class="col-md-4" style="flex-grow: 1;">
                <div class="form-group" style="margin-left: 20px; margin-top: 20px;"> <!-- Added margin-top for vertical alignment -->
                    <button type="button" class="btn btn-default" style="font-size: 14px; border-radius: 20px; padding: 5px 15px; border-color: gray; border-width: 1px;">@lang('Run report')</button>
                </div>
            </div>
        </div>
        ...
        @if(count($budget) != 0)
            @include('quickbooks::business_overview.budget_actuals.budget_table')
        @else
            <div class="row">
...
<div class="modal fade" id="add_budget_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        {!! Form::open(['url' => action([\Modules\Quickbooks\Http\Controllers\BudgetActualController::class, 'create']), 
...
<script type="text/javascript">
	$(document).ready( function(){
        $('#fiscal_year_picker').datepicker({
            ...
            "{{action([\Modules\Quickbooks\Http\Controllers\BudgetActualController::class, 'index'])}}?financial_year=" + $('#fiscal_year_picker').val();
        });
