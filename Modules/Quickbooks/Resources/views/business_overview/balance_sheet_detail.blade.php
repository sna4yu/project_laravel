...
@section('title', __('Balance Sheet Detail'))
    ...
    <section class="content" style="background-color: #f7f8fa;">
        <div class="row" style="padding: 20px; background-color: #f7f8fa;">
            <div class="box-body" style="background-color: #F4F5F8;">
                ...
                <a href="http://127.0.0.1:8000/quickbooks/report_management" class="btn btn-link"
                ...
                <form class="form-inline"
                    ...
                    <div class="form-group" style="margin-left: auto;">
                        <button type="button" class="btn btn-outline-secondary"
                            style="font-size: 16px; border-radius: 20px; padding: 5px 15px; border-color: gray; color:#000">@lang('Customise')</button>
                        <button type="button" class="btn btn-success"
                            style="font-size: 16px; border-radius: 20px; padding: 5px 15px; background-color: #2ca01c;">@lang('Save customisation')</button>
                    </div>
                    ...
                    <div
                        ...
                        <div class="form-group" style="margin-right: 15px;">
                            {!! Form::label('ageing_method', __('Accounting method'), [
                                'style' => 'display: block; font-size: 12px; color: #333;',
                            ]) !!}
                            <div class="radio" style="display: inline-block; margin-right: 10px;">
                                ...
                                {!! Form::label('current', __('Cash'), ['style' => 'font-size: 12px; color: #333;']) !!}
                            </div>
        ...
        <div class="col-md-12" style="background-color: #f7f8fa;">
            <div class="box" style="background-color: #f7f8fa;">
                <div class="box-header with-border text-center" style="background-color: #f7f8fa;">
                    ...
                    <p class="box-title"><b>Balance Sheet Detail</b></p>
                    ...
                    <table class="table table-striped table-bordered"
                        ...
                        <thead style="background-color: #ffffff;">
                            <tr style="border-top: 2px solid #000; border-bottom: 2px solid #000;">
                                <th
                                    style="width: 10%; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: left; color:#000;">
                                    DATE
                                </th>
                                <th
                                    style="width: 15%; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: left; color:#000;">
                                    TRANSACTION TYPE
                                </th>
                                <th
                                    style="width: 5%; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: left; color:#000;">
                                    NO.
                                </th>
                                <th
                                    style="width: 15%; border-bottom: 1px solid #000; border-right: 1px solid #000; text-align: left; color:#000;">
                                ...
                                <th
                                    style="width: 5%; text-align: right; border-bottom: 1px solid #000; border-right: 1px solid #000; color:#000;">
                                    DEBIT
                                </th>
                                <th
                                    style="width: 5%; text-align: right; border-bottom: 1px solid #000; border-right: 1px solid #000; color:#000;">
                                ...
                                <th
                                    style="width: 10%; text-align: right; border-bottom: 1px solid #000; border-right: 1px solid #000; color:#000;">
                                    AMOUNT
                                </th>
                                <th style="width: 10%; text-align: right; border-bottom: 1px solid #000; color:#000;">
                                    BALANCE
                                </th>
                            </tr>
                        </thead>
                                    ...
                                    @foreach ($account_sub_types->where('account_primary_type', $type)->all() as $sub_type)
                                        ...
                                        @foreach ($subtype_accounts as $account)
                                            <tr class="account-row" data-balance="{{ $account->balance }}"
                                                ...
                                                <td style="padding-left: 20px; text-align: right; border-left: none; border-right: none;"
                                                    colspan="2">{{ $account->name }}</td>
                                        ...
                                        @endforeach
                                        <tr style="background-color: #ffffff;">
                                            <td style="padding-left: 10px; font-weight: bold; text-align: right; border-left: none; border-right: none;"
                                                colspan="2">
                                                Total for {{ $sub_type->account_type_name }}
                                            </td>
                                            <td colspan="8" style="border-left: none; border-right: none;"></td>
                                            <td
                                                style="text-align: center; font-weight: bold; border-left: none; border-right: none;">
                                                @format_currency($total_balance)
                                            </td>
                                        </tr>
                                    @endforeach
                                    <tr
                                        style="border-top: 1px double #000; border-bottom: 3px double #000; padding-left: 10px; font-weight: bold; background-color: #ffffff;">
                                        <td style="text-align: left; border-left: none; border-right: none;" colspan="2">
                                            Total for {{ $details['label'] }}</td>
                                        <td colspan="8" style="border-left: none; border-right: none;"></td>
                                        <td
                                            style="text-align: left; font-weight: bold; border-left: none; border-right: none; font-size:14px;">
                                            @format_currency($primary_type_total_balance)</td>
                                    </tr>
                                @endif
                            @endforeach
                        </tbody>
