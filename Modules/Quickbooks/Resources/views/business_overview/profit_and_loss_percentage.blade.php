...
@section('title', __('Profit and Loss as % of total income'))
        ...
        <section class="content" style="background-color: #ffffff;">
            <div class="row" style="padding: 20px; background-color: #ffffff;">
                <div class="box-body" style="background-color: #F4F5F8;">
                    ...
                    <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 20px; padding-left: 12px;">Profit and Loss as % of total income Report</h3>
            ...
            <div class="col-md-10 col-md-offset-1" style="background-color: #ffffff;">
                <div class="box" style="background-color: #ffffff;">
                    ...
                    <div class="box-header with-border text-center">
                        ...
                        <p><b>Profit and Loss as % of total income</b></p>
                    ...
                    <div>
                        <table class="table table-striped table-bordered"
                            ...
                            <thead style="background-color: #ffffff;">
                                <tr>
                                    <th
                                        style="width: 50%; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; text-align:left;">
                                    </th>
                                    <th colspan="2"
                                        style="width: 25%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align:center;">
                                        Total Balance
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th
                                        style="width: 25%; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; text-align:right;">
                                        {{ @format_date($start_date) }} ~ {{ @format_date($end_date) }}
                                    </th>
                                    <th
                                        style="width: 25%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align:right;">
                                        % of Income
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($filtered_account_types as $type => $details)
                                    @php
                                        $primary_type_total_balance = $accounts
                                            ...
                                            ->sum('balance');
                                        $percentage_of_income = $total_income
                                            ? ($primary_type_total_balance / $total_income) * 100
                                            : 0;
                                    @endphp
                                    <tr style="background-color: #ffffff;">
                                        <td colspan="3">
                                                    ...
                                                    <div style="padding-left: 20px; background-color: #ffffff;">
                                                        ...
                                                        <div class="dropdown-content" style="display: block;">
                                                            @php
                                                                ...
                                                                $subtype_percentage_of_income = $total_income
                                                                    ? ($total_balance / $total_income) * 100
                                                                    : 0;
                                                            @endphp
                                                            @foreach ($subtype_accounts as $account)
                                                                @php
                                                                    $account_percentage_of_income =
                                                                ...
                                                                <div class="account-row"
                                                                    ...
                                                                    <span
                                                                        style="text-align: right;">@format_currency($account->balance)</span>
                                                                    <span
                                                                        style="text-align: right;">{{ number_format($account_percentage_of_income, 2) }}%</span>
                                                                </div>
                                                            @endforeach
                                                            <div
                                                                ...
                                                                <span style="text-align: right;">{{ number_format($subtype_percentage_of_income, 2) }}%</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            ...
                                            <span style="text-align: right;">@format_currency($total_expenses)</span>
                                            <span style="text-align: right;">{{ number_format($total_expenses_percentage, 2) }}%</span>
                                        </div>                                        
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div
                        ...
                        <span style="text-align: right;">@format_currency($net_earnings)</span>
                    </div>
                </div>
            </div>
        </section>
