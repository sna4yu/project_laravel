...
@section('title', __('Profit and Loss by Month'))

@section('content')

    <section class="content" style="background-color: #ffffff;">
        <div class="row" style="padding: 20px; background-color: #ffffff;">
            <div class="box-body" style="background-color: #f8f6f4;">
                ...
                <!-- Title -->
                <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 20px; padding-left: 12px;">Profit and Loss by
                    Month Report</h3>
        ...
        <div class="col-md-10 col-md-offset-1" style="background-color: #ffffff;">
            <div class="box" style="background-color: #ffffff;">
                <div class="box-header with-border text-center">
                    ...
                    <h5 class="box-title"><b>Profit and Loss by Month Report</b></h5>
                    <p>As of {{ @format_date($start_date) }} ~ {{ @format_date($end_date) }}</p>
                </div>

                <div>
                    <table class="table table-bordered"
                        style="width: 100%; border-collapse: collapse; background-color: #ffffff; table-layout: auto;">
                        <thead style="background-color: #ffffff;">
                            <tr style="font-size: 12px;">
                                <th
                                    style="width: 30%; border: 1px solid #000; text-align: left; padding: 8px; white-space: nowrap;">
                                    Account</th>
                                @foreach (['JAN 2024', 'FEB 2024', 'MAR 2024', 'APR 2024', 'MAY 2024', 'JUN 2024', 'JUL 2024', 'AUG 2024', 'SEP 2024', 'OCT 2024'] as $month)
                                    <th
                                        style="width: 6.3%; border: 1px solid #000; text-align: center; padding: 8px; white-space: nowrap;">
                                        {{ $month }}</th>
                                @endforeach
                                <th
                                    style="width: 10%; border: 1px solid #000; text-align: right; padding: 8px; white-space: nowrap;">
                                    TOTAL</th>
                            </tr>
                        </thead>
                        <tbody id="balance-sheet-body" style="background-color: #ffffff;">
                            @foreach ($filtered_account_types as $type => $details)
                                ...
                                <tr style="background-color: #ffffff;">
                                    <td colspan="{{ count($months) + 2 }}" style="padding: 8px;">
                                                        ...
                                                        @foreach ($subtype_accounts as $account)
                                                            <div class="account-row"
                                                                ...
                                                                @foreach ($months as $month)
                                                                    <span
                                                                        style="flex: 1; text-align: right; white-space: nowrap;">@format_currency($account->{'balance_' . $month})</span>
                                                                @endforeach
                                                                <span
                                                                    style="flex: 1; text-align: right; white-space: nowrap;">@format_currency($account->total)</span>
                                                            </div>
                                                        @endforeach
                                                        <div
    ...
    <script type="text/javascript">
        ...
        function toggleDropdown(button) {
            ...
            if (dropdownContainer.style.display === "none" || dropdownContainer.style.display === "") {
                ...
                button.innerHTML = button.innerHTML.replace(arrow, '&#9660;'); // Change arrow to down
            } else {
                dropdownContainer.style.display = "none";
                button.innerHTML = button.innerHTML.replace(arrow, '&#9654;'); // Change arrow to right
            }
        }
