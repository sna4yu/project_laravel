...
@section('title', __('Profit and Loss Detail'))
        ...
        <section class="content" style="background-color: #ffffff;">
            <div class="row" style="padding: 20px; background-color: #ffffff;">
                <div class="box-body" style="background-color: #F4F5F8;">
                    ...
                    <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 20px; padding-left: 12px;">Profit and Loss Detail Report</h3>
            ...
            <div class="col-md-10 col-md-offset-1" style="background-color: #ffffff;">
                <div class="box" style="background-color: #ffffff;">
                    ...
                    <div class="box-header with-border text-center">
                        ...
                        <p><b>Profit and Loss Detail</b></p>
                        <p> As of {{ @format_date($start_date) }} ~ {{ @format_date($end_date) }} </p>
                        </div>

                    <div>
                        <table class="table table-bordered" style="min-height: 300px; width: 100%; border-collapse: collapse; background-color: #ffffff;">
                            <thead>
                                <tr>
                                    <th style="width: 15%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: left;">Date</th>
                                    <th style="width: 20%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: left;">Transaction Type</th>
                                    <th style="width: 25%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: left;">Description</th>
                                    <th style="width: 20%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: left;">Split</th>
                                    <th style="width: 10%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: right;">Amount</th>
                                    <th style="width: 10%; border-top: 1px solid #000; border-bottom: 1px solid #000; text-align: right;">Balance</th>
                                </tr>
                            </thead>
                            <tbody id="balance-sheet-body" style="background-color: #ffffff;">
                                @foreach ($filtered_account_types as $type => $details)
                                    <!-- Primary Account Type Section -->
                                    <tr style="background-color: #ffffff;">
                                        <td colspan="6" style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                                                    ...
                                                    <div style="padding-left: 20px; background-color: #ffffff;">
                                                        ...
                                                        <div class="dropdown-content" style="display: block;">
                                                           ...
                                                           <div class="account-row"
                                                               ...
                                                               style="padding-left: 20px; display: flex; justify-content: space-between; align-items: center; background-color: #ffffff;">
                                                               <a href="{{ route('accounting.ledger', $account->id) }}"
                                                                   style="text-decoration: none; color: inherit;">
                                                                   <span>{{ @format_date($account->created_at) }}</span>
                                                               </a>
                                                               <span style="width: 20%;"></span> <!-- Placeholder for Transaction Type -->
                                                               <span style="width: 25%;"></span> <!-- Placeholder for Description -->
                                                               <span style="width: 20%;"></span> <!-- Placeholder for Split -->
                                                               <span style="width: 10%; text-align: right;">@format_currency($account->balance)</span> <!-- Amount Column -->
                                                               <span style="width: 10%; text-align: right;">@format_currency($account->balance)</span> <!-- Balance Column -->
                                                           </div>
                                                       @endforeach                                                       
                                                            <div
                                                                style="border-top: 1px solid #000; padding-left: 10px; font-weight: bold; display: flex; justify-content: space-between; align-items: center; background-color: #ffffff;">
                                                                <span>Total for {{ $sub_type->account_type_name }}</span>
                                                                <span style="text-align: right;">@format_currency($total_balance)</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            ...
                                            <div style="border-top: 1px solid #000; padding-left: 10px; font-weight: bold; display: flex; justify-content: space-between; align-items: center; background-color: #ffffff;">
                                                <span>Total for {{ $details['label'] }}</span>
                                                <span style="text-align: right;">@format_currency($primary_type_total_balance)</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div style="border-top: 1px solid #000; padding-left: 10px; font-weight: bold; background-color: #ffffff;">
