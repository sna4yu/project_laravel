    ...
    <div class="box box-default">
        <div class="box box-default" style="background-color: #356bd7;">
            ...
            <a href="http://127.0.0.1:8000/test/report_management" class="btn btn-link"
                    ...
                    <!-- Title -->
                    <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 20px; padding-left: 20px;">Account Payable Ageing Detail Report</h3>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="box box-default">
                        <div class="box-header with-border text-center">
                            ...
                            <h5 class="box-title"><b>Account Payable Ageing Detail</b></h5>
