    ...
    <div class="col-md-10 col-md-offset-1" style="background-color: #ffffff;">
        <div class="box" style="background-color: #ffffff;">
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-striped" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
                            ...
                            @foreach ($account_types as $type => $details)
                                ...
                                <tr style="background-color: #f7f8fa;">
                                    <td colspan="7" style="font-weight: bold; background-color: #f7f8fa;">
                                        <button onclick="toggleDropdown(this)" style="cursor: pointer; text-align: left; border: none; outline: none; background-color: #f7f8fa; width: 100%; padding: 10px;">
                                    ...
                                    <td colspan="7">
                                        @foreach ($account_sub_types->where('account_primary_type', $type)->all() as $sub_type)
                                            ...
                                            @endphp
                                                ...
                                                <tr>
                                                    <td colspan="7" style="padding-left: 20px; background-color: #f7f8fa; font-weight: bold;">
                                                        <button onclick="toggleDropdown(this)" style="cursor: pointer; text-align: left; border: none; outline: none; background-color: #f7f8fa; width: 100%; padding: 10px;">
                                                            <span class="arrow">&#9660;</span> <!-- Expanded by default -->
                                                ...
                                                <tr class="dropdown-content" style="display: table-row;"> <!-- Expanded by default -->
                                                    <td colspan="7">
                                                            ...
                                                            @foreach ($subtype_accounts as $account)
                                                                <tr style="background-color: #f7f8fa;">
                                                                    <td style="padding-left: 40px;" colspan="5"><a href="{{ route('accounting.ledger', $account->id) }}"
                                                                        style="text-decoration: none; color: inherit;">{{ $account->name }}</td>
                                                                    <td style="text-align: right;"> <a href="{{ route('accounting.ledger', $account->id) }}" style="text-decoration: none; color: inherit;">@format_currency($account->debit)</a></td>
                                                                    <td style="text-align: right;"> <a href="{{ route('accounting.ledger', $account->id) }}" style="text-decoration: none; color: inherit;">@format_currency($account->credit)</a></td>
                                                                </tr>
                                                ...
                                                <tr style="border-top: 1px solid #000; background-color: #f7f8fa;">
                                                    <td colspan="2" style="font-weight: bold;">Total for {{ $sub_type->account_type_name }}</td>
