...
use Modules\InvetoryMangament\Entities\inventoryProducts;
use Modules\InvetoryMangament\Entities\InventoryTransaction;
use Modules\InvetoryMangament\Entities\Inventory as InventoryModel;
...
class InvetoryMangamentController extends Controller
{
    ...
    public function updateStatus($id,Request $request){
            ...
            return response()->json(['status'=>true,'msg'=>__('invetorymangament::inventory.inv_updated')]);
    }
    /**
    ...
    public function index()
    {
        ...
        return view('invetorymangament::index',compact('branches'));
    }
    ...
    public function createNewInventory(Request $request){
        ...
        return redirect(action('\Modules\InvetoryMangament\Http\Controllers\InvetoryMangamentController@showInventoryList'));
    }
    
    public function showInventoryList(){
        $business_id = request()->session()->get('user.business_id');
        $inventories = InventoryModel::business()->with('branch')->orderBy('id','desc')->get();
        return view("invetorymangament::showInventoryList" , compact("inventories"));
    }
    ...
    public function makeInevtory($id){
        ...
        if($inventories->status){
            ...
            return view("invetorymangament::makeInventory",
            compact("id" , "inventories" , "quantityProductsArray",'products'));
        }else{
            return view("invetorymangament::closed",
            compact("id" , "inventories" , "quantityProductsArray",'products'));
        }
    }
            ...
            if (!empty($product_id)) {
                ...
                if($variations){
                    ...
                    if($product_qty > 0){
                        ...
                        return response()->json([
                             'msg' => [
                                'title'=>__('invetorymangament::inventory.empty_qty_product'),
                                'text'=>__('invetorymangament::inventory.plz_add_qty_product')
                                ],
                            'status' => false
                        ]);
                    }
                    ...
                    if(! in_array($variations->id , $needle[$location_content])){
                        ...
                        return response()->json(['msg'=>[
                            'title'=>__('invetorymangament::inventory.oops'),
                            'text'=>__('invetorymangament::inventory.product_al_exists')
                    ],'status'=>false]);
                    }
                    Session::remove('duplicatedProductsPerBranch');
                    return view('invetorymangament::partials.tablerow',compact(
                        'product',
                        'variations',
                        "productQuantity"
                    ));
                }else{
                    return response()->json(['msg'=>['title'=>__('invetorymangament::inventory.oops'),'text'=>__('invetorymangament::inventory.notfound')],'status'=>false]);
                }
    ...
    public function showInventoryReports ($id , $branch_id){
        ...
        return view("invetorymangament::showInventoryReports" ,
    ...
    public function inventoryIncreaseReports($inventory_id , $branch_id){
        ...
        return view("invetorymangament::increaseReports" , compact("increaseProductReport",'variations'));
    }
    ...
    public function inventoryDisabilityReports($inventory_id , $branch_id){
        ...
        return view("invetorymangament::disabilityReports" , compact("disabilityProductReport" ,"variations"));
    }
}
