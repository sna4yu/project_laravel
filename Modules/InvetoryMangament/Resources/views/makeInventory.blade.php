    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header text-center" style="background-color:#484848;color:#EDAF11;font-size: 30px;">
                @lang("invetorymangament::inventory.products_inventory")
            </div>
        </div>
        <div class="box-body">
            <div class="row">
        ...
        <table id="purchase_entry_table" class="display nowrap table table-bordered table-hover table-th-green" style="width:100%">
          ...
          @include("invetorymangament::partials.tableRowForListing" , [$inventories , $quantityProductsArray,$products])
           </tbody>
...
@endsection
@include("invetorymangament::partials.modals.editProductInventoryModal")
@section('javascript')
