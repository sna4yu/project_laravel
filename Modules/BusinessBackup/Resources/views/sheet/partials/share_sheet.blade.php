<div class="modal-dialog" role="document">
    {!! Form::open(['action' => '\Modules\BusinessBackup\Http\Controllers\BusinessBackupController@postShareBusinessBackup', 'id' => 'share_businessbackup', 'method' => 'post']) !!}
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    @lang('businessbackup::lang.share_excel')
                </h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('todo', __('businessbackup::lang.todos') .':') !!}
