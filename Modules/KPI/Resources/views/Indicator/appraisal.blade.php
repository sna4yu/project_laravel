        ...
        <div class="col-md-12">
            <div class="card shadow-lg p-4 mb-5 bg-white rounded" style="border: 1px solid #e3e3e3; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);">
                ...
                <div class="card-body">
                    ...
                    <!-- Appraisal Month Input -->
                    <div class="form-group row justify-content-center">
                        <label for="appraisal_month" class="col-sm-5 col-form-label text-right">Select Month <span class="text-danger">*</span>:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary" id="goButton">Go</button> <!-- Triggers form submission with GET -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="bg-light">
                                                <th>#</th>
                                                <th>Indicator</th>
                                                <th>Expected Value</th> <!-- Added Expected Value Column -->
                                                <th>Competency Score (Expect)</th>
                                                <th>Actual Value</th>
                                                <th class="score-width">Actual Score</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="technical[{{ $competency->id }}][actual_value]" class="form-control actual-value" placeholder="Enter actual value" data-expected-value="{{ $competency->value }}" data-competency-score="{{ $competency->score }}" data-score-input="technical-score-{{ $competency->id }}" data-pers-input="technical-pers-{{ $competency->id }}" value="{{ $scoreData ? $scoreData->actual_value : '' }}">
                                                ...
                                                <td>
                                                    <!-- Input for Notes -->
                                                    <textarea name="technical[{{ $competency->id }}][note]" class="form-control" placeholder="Enter note (optional)">{{ $scoreData ? $scoreData->note : '' }}</textarea>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="col-md-12">
                            <div class="card shadow-lg p-4 mb-5 bg-white rounded" style="border: 1px solid #e3e3e3; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);">
                                <h3 class="card-header bg-light" style="border-bottom: 2px solid #007bff;">Behavioural / Organizational Competencies</h3>
                                <div class="card-body">
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="bg-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $competency->score }}</td> <!-- Display the Expected Score -->
                                                <td>
                                                    <input type="number" name="behavioral[{{ $competency->id }}][actual_value]" class="form-control actual-value" placeholder="Enter actual value" data-expected-value="{{ $competency->value }}" data-competency-score="{{ $competency->score }}" data-score-input="behavioral-score-{{ $competency->id }}" data-pers-input="behavioral-pers-{{ $competency->id }}" value="{{ $scoreData ? $scoreData->actual_value : '' }}">
                                                ...
                                                <td>
                                                    <!-- Input for Notes -->
                                                    <textarea name="behavioral[{{ $competency->id }}][note]" class="form-control" placeholder="Enter note (optional)">{{ $scoreData ? $scoreData->note : '' }}</textarea>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
