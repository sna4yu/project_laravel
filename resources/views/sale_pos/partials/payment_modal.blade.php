                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row @if ($change_return['amount'] == 0) hide @endif payment_row"
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('sale_note', __('sale.sell_code_note') . ':') !!}
                                    {!! Form::text('sale_note', !empty($transaction) ? $transaction->additional_notes : null, [
                                        'class' => 'form-control',
                                        'rows' => 3,
                         ...
                         <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('delivery_person', $users, auth()->user()->id, [
                                        'class' => 'form-control',
                                        'placeholder' => __('messages.please_select'),
                                        'id' => 'delivery_person_select',
                                    ]) !!}
                                </div>
                            </div>
                         ...
                         <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('staff_note', !empty($transaction) ? $transaction->staff_note : null, [
                                        'class' => 'form-control',
                                        'rows' => 3,
