    ...
    {{-- <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{ $go_back_url }}" title="{{ __('lang_v1.go_back') }}"
                ...
                <strong><i class="fa fa-home-lg"></i></strong>
            </a>
...
@if (empty($pos_settings['hide_product_suggestion']))
    <a href="{{ $go_back_url }}" title="{{ __('lang_v1.go_back') }}"
        class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer tw-border-2 tw-flex tw-items-center tw-justify-center tw-rounded-md tw-w-8 tw-h-8 tw-text-gray-600 pull-right md:tw-hidden">
        <strong class="!tw-m-3">
            <i class="fa fa-home fa-lg fa-backward tw-fa-lg tw-text-red-600 !tw-text-sm"></i>
        </strong>
    </a>
@endif
        ...
        <div class="tw-w-full md:tw-w-2/3 !tw-p-0 tw-flex tw-items-center tw-justify-between tw-gap-1 tw-flex-col md:tw-flex-row tw-hidden md:tw-flex"
           ...
           <a href="{{ $go_back_url }}" title="{{ __('lang_v1.go_back') }}"
    class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-red-600 hover:tw-bg-blue-700 tw-cursor-pointer tw-border-2 tw-flex tw-items-center tw-justify-center tw-rounded-md md:tw-w-8 tw-w-auto tw-h-8 tw-text-white pull-right">
    <strong class="!tw-m-3">
        <i class="fa fa-home fa-lg fa fa-backward tw-fa-lg tw-text-white !tw-text-sm"></i>
