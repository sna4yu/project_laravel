...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
      ...
      $menu->url(action([\Modules\SocialManagement\Http\Controllers\SocialManagementController::class, 'index']), __('Social Media Audit'), ['icon' => '<svg aria-hidden="true" class="tw-size-5 tw-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  ...
                  </svg>', 'active' => request()->segment(1) == 'home'])->order(50000);
